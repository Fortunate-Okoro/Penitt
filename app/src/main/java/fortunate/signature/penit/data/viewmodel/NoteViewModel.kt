...
import fortunate.signature.penit.misc.applySpans
...
class NoteViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private fun getBaseNote(): BaseNote {
        ...
        return BaseNote(id, folder, title, pinned, timestamp, labels, trimmedBody, spans, filteredItems)
    }

    private fun getFilteredSpans(spannable: Spannable): java.util.ArrayList<SpanRepresentation> {
    ...
    private fun getFilteredRepresentations(representations: java.util.ArrayList<SpanRepresentation>): java.util.ArrayList<SpanRepresentation> {
